...
5. **Knowledge review:** ad-hoc communication capture, transcript signal extraction, new/duplicate/support/conflict comparison, bounded AI-assisted backlog triage, policy-versus-one-off classification, search/repository/type/recommendation filters, pagination and selection, guarded human-confirmed bulk add/ignore, evidence, confidence explanation, contradictions, statement/scope/class editing, evidence-preserving merge, approve, reject, challenge, archive, and manual confirmation.
