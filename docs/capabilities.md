...
The React application currently exposes dashboard context preparation, repository connection/import/retention/deletion, candidate review and merge, knowledge creation/challenge/archive, policy creation, reviewer views, sessions, safety reports, onboarding help, keyboard navigation, and explicit disconnected/loading states.
